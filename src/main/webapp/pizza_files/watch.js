(function (h, f, ba) {
    ...
    function oa(a, b) {
        if (.01 > Math.random())try {
            (new S).log("jserrs", U, a.message, b, A.href, O, "string" == typeof a.stack && a.stack.replace(/\n/g, "\\n"))
        } catch (e) {
            var c = ["cp: " + b, a.name + ": " + a.message, "debug: " + O, "code: " + U, "stack: " + a.stack];
            (new Image).src = "//an.yandex.ru/jserr/101500?cnt-class=100&errmsg=" + encodeURIComponent(c.join("; ").replace(/\r?\n/g, "\\n"))
        }
    }

    function cb(a, b, c) {
        return h.setTimeout(t(a,
            c || "setTimeout"), b)
    }
    ...
    function ib(a) {
        ...
        for (var c = a.patterns, e = 0; e < c.length; e++)if (b.match(new RegExp(c[e], "i"))) {
            var d = a.params || [];
            if (d.length)for (var u = g.safeDecodeURIComponent((RegExp.$1 || "").replace(/\+/g, "%20")), h = 0; h < d.length; h++) {
                if (u == g.safeDecodeURIComponent(d[h]))return !0
            } else return !0
        }
        return !1
    }
    ...
    function La(a,
        ...
        if (a && "string" != typeof a && a.length)for (var e = 0; e < a.length; e++) {
            ...
            if ("#" == h) {
                if (h = f.getElementById(d))c = !0, b && M.unshift([h, h.innerHTML]), h.innerHTML = g
            } else if ("." == h)for (h = l.getElementsByClassName(d), d = 0; d < h.length; d++) {
                var c = !0, k = h[d], ja = g;
                b && M.unshift([k, k.innerHTML]);
                k.innerHTML = ja
            }
        }
        return c
    ...
    function Ma() {
        for (var a = 0; a < M.length; a++)M[a][0].innerHTML = M[a][1]
    }
    ...
    function jb(a, b) {
        ...
        d && (d = -1 < d.indexOf(";") ? g.safeDecodeURIComponent(d) : V.decode(d.replace(/[-*_]/g, function (a) {
            return {"*": "+", "-": "/", _: "="}[a] || a
        })));
    ...
    function kb(a, b, c, e, d) {
        ...
        function Q(a) {
            var b = a[B];
            if (!b || 0 > b || !/^INPUT|SELECT|TEXTAREA$/.test(a.nodeName) || !a.form || V(a.form))return null;
            var c =
        ...
        function G(a) {
            if (a[B])a:{
                ...
                if (a.nodeName)if (c = +a[B], !isFinite(c) || 0 >= c)b = null; else {
                    ...
                    0 > g && (g = 0);
                    var h = a.nodeName.toUpperCase(), q = R[h];
                    q || (d |= 2);
                    var x = l.getElementNeighborPosition(a);
                    x || (d |= 4);
                    var u = l.getElementRegion(a);
                    (f = f ? l.getElementRegion(f) : null) && u[0] == f[0] && u[1] == f[1] && u[2] ==
                    f[2] && u[3] == f[3] && (d |= 8);
                    ta[c].pos = u[0] + "x" + u[1];
                    ta[c].size = u[2] + "x" + u[3];
                    a.id && "string" == typeof a.id && (d |= 32);
                    (f = l.calcTextChecksum(a)) && (d |= 16);
                    var T = l.calcAttribChecksum(a);
                    T && (e |= 2);
                    var k;
                    b:{
                        k = l.getElementChildren(l.getElementParent(a), a.tagName);
                        for (var H = 0; H < k.length; H++)if ((!k[H].id || "string" != typeof k[H].id) && l.calcAttribChecksum(k[H]) == T && l.calcTextChecksum(k[H]) == f) {
                            k = !0;
                            break b
                        }
                        k = !1
        ...
        function x(a) {
            ...
            if (b && "SCROLLBAR" != b.nodeName) {
                ...
                w(y, [E(), a.type, b, F.getPos(a), a.which, a.button])
            }
        }
        ...
        function H(a) {
            var b = T(), c = b - aa;
            if (!(10 > c)) {
                var d = F.getPos(a), e = ha[0] - d[0], g = ha[1] - d[1], e = e * e + g * g;
                0 >= e || 16 > e && 100 > c || 20 > c && 256 > e || (aa = b, ha = d, x(a))
            }
        }

        function ua() {
            var a = l.getDocumentScroll(), b = T();
            10 > b - na || 10 > Math.abs(a[0] - ia[0]) && 10 > Math.abs(a[1] - ia[1]) || (na = b, ia = a, w(I, [E(), a]))
        }
        ...
        function Fa() {
            w(L, [E(), l.getViewportSize(), l.getDocumentSize()])
        }
        ...
        function Da(a) {
            return "INPUT" == a.tagName ? "password" == a.type || a.name && ca.test(a.name) || a.id && ca.test(a.id) : !1
        }

        function Pa(a, b, c) {
            a = F.getTarget(a);
            Da(a) || M(a) || (G(a), w(K, [E(), b, c, a]))
        }
        ...
        function Qa(a) {
            ...
            if ({
                    ...
                    144: 1,
                    145: 1
                }[b] || 112 <= b && 123 >= b || 96 <= b && 105 >= b || c & 16)19 == b && 4 == (c & -17) && (b = 144), Pa(a, b, c | 16), ma = !1, g.setTimeout(function () {
                ma = !0
            }, 1), !(67 == b && c & 4) || c & 1 || c & 2 || Ga()
        }

        function Ra(a) {
            ma && !da && 0 !== a.which && (Pa(a, a.charCode || a.keyCode, Oa(a)), da = !0, g.setTimeout(function () {
                da = !1
            }, 1))
        }

        function Ga() {
            Ha || (Ha = !0, Ea && w(Y, [E()]), g.setTimeout(function () {
                Ha = !1
            }, 1))
        }
        ...
        function xa(a) {
            (a = F.getTarget(a)) && /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(a.tagName) && (G(a), w(P, [E(), a]))
        }

        function ya(a) {
            a = F.getTarget(a);
            if (!Da(a) && !M(a) && a && /^INPUT|SELECT|TEXTAREA$/.test(a.tagName)) {
        ...
        function Z(a) {
            ...
            if (a.touches && a.touches.length) {
                ...
                if (b && b != f) {
                    G(b);
                    for (var c = 0; c < a.touches.length; c++)w(y, [E(), "touch", b, [a.touches[c].pageX,
                        a.touches[c].pageY], 0, 0])
                }
            }
        }
        ...
        function J(a) {
            ...
            if (b) {
                ...
                c && (G(b), w(A, [E(), b, F.getPos(a), c]))
            }
        }

        function fa(a) {
            (a = F.getTarget(a)) && "BODY" == a.tagName && pa.append([], !0)
        }
        ...
        u(0);
        var U = 0, ea = 1, aa = 0, ha = [0, 0], na = 0, ia = [0, 0], la = {}, ca = /^(password|passwd|pswd)$/, ma = !0, da = !1, Ea = "", Ha = !1, ra = !0, oa = T(), B = "metrikaId_" + Math.random(), ta = {}, Ba = ":submit" + Math.random();
        if (!g.isMetrikaPlayer()) {
            k.on(f, "mousemove", H);
            k.on(f, "click,dblclick,mousedown", x);
            k.on(f, "mouseup", q);
            k.on(h, "scroll", ua);
            if ("onmousewheel"in f)k.on(f, "mousewheel", J); else k.on(f,
                "wheel", J);
            k.on(h, "beforeunload", va);
            if (!mb)k.on(h, "unload", va);
            k.on(h, "resize", Fa);
            k.on(f, "keydown", Qa);
            k.on(f, "keypress", Ra);
            k.on(f, "copy", Ga);
            k.on(f, "touchmove,touchstart", Z);
            if (f.body)k.on(f, "mouseleave", fa);
            f.attachEvent && !h.opera ? (k.on(f, "focusin", Sa), k.on(f, "focusout", Ta)) : (k.on(h, "focus", Ia), k.on(h, "blur", sa), k.on(f, "blur", sa));
            f.addEventListener ? (k.on(f, "scroll", C), k.on(f, "focus", wa), k.on(f, "blur", xa), k.on(f, "change", ya), k.on(f, "submit", W)) : f.attachEvent && (k.on(f, "focusin", wa), k.on(f, "focusout",
                xa), function () {
            ...
            d.uploadPage = t(function (d) {
                ...
                var q = h.XMLHttpRequest ? new h.XMLHttpRequest : new ActiveXObject("Msxml2.XMLHTTP"), u = l.getDocumentCharset(), x = "text/html" + (u ? ";charset=" + u : ""), k = new nb({
                    protocol: a,
                    counterId: b,
                    counterType: c
                });
                if ("html" == d)return d = RegExp("<script [^>]*?//mc\\.yandex\\.ru/watch/.*?\x3c/script>",
                    "gi"), k.sendContent(l.getDocumentHTML().replace(d, ""), x, e, za, Aa), !0;
                q && (q.open("get", z().href, !0), q.onreadystatechange = t(function () {
                    if (4 == q.readyState) {
                        var a = q.getResponseHeader("content-type") || "";
                        u && -1 === a.indexOf("charset=") && (a = x);
                        k.sendContent(q.responseText, a, e, za, Aa)
                    }
                }, "updatePage.1"), q.overrideMimeType && u && q.overrideMimeType(x), q.send(null));
                return !0
            }, "uploadPage")
        }
        return {
            start: function () {
                ...
                f.body && k.un(f, "mouseleave", fa);
                k.un(f, "focusin", Sa);
                k.un(f, "focusout", Ta);
                k.un(h, "focus", Ia);
                k.un(h, "blur", sa);
                k.un(f, "blur", sa);
                f.removeEventListener ? (k.un(f, "scroll", C), k.un(f, "focus", wa), k.un(f, "blur", xa), k.un(f, "change", ya), k.un(f, "submit", W)) : f.detachEvent && (k.un(f,
                    "focusin", wa), k.un(f, "focusout", xa), function () {
                    for (var a = f.getElementsByTagName("form"), b = 0; b < a.length; b++) {
                ...
                (function () {
                    for (var a = f.getElementsByTagName("form"), b = 0; b < a.length; b++)a[b][Ba] && (a[b].submit = a[b][Ba])
                })()
    ...
    var O = "", mb = !ia(/webkit/) && ia(/gecko/), l = {
        getDocumentCharset: function () {
            ...
            if (c)a = c; else {
                for (var c =
                    a.attributes, e = "", d = 0; d < c.length; d++) {
                    var g = c[d];
                    g && (e += " " + g.name + '="' + (g.value || "") + '"')
                }
        ...
        isArray: function (a) {
            ...
            for (var b = 1; b < arguments.length; b++)if (g.isArray(arguments[b]))for (var c = 0; c < arguments[b].length; c++)a[a.length] =
                arguments[b][c];
            return a
        }
    };
    ...
    l.getElementSize = function (a) {
        if (a == f.body ||
            a == f.documentElement)return l.getDocumentSize();
    ...
    l.calcAttribChecksum = function (a) {
        ...
        for (var b = b + String(a.className || "").toLowerCase(), e = 0; e < c.length; e++)a.getAttribute && (b += String(a.getAttribute(c[e]) ||
        "").toLowerCase());
        return g.fletcher(b.replace(/[\u0000-\u0020]+/g, ""))
    };
    ...
    l.isEmptyField = function (a) {
        return "INPUT" == a.nodeName && "submit" != a.type &&
        "image" != a.type && "hidden" != a.type ? "radio" == a.type || "checkbox" == a.type ? !a.checked : !a.value : "TEXTAREA" == a.nodeName ? !a.value : "SELECT" == a.nodeName ? 0 > a.selectedIndex : !0
    };
    ...
    var r = I.inherit({
        postParams: [], _buildUrl: function (a, b) {
            return a + (-1 < a.indexOf("?") ? "&" : "?") + W.stringify(b)
    ...
    var p = {
        getLanguage: function () {
            return (h.navigator && (y.language || y.userLanguage || y.browserLanguage || y.systemLanguage) || "").toLowerCase()
        }
    }, pb = {
        baseUrl: "https://mc.yandex.", baseTld: "ru", syncTlds: ["ua",
            ...
            c.length && (e = new ob({method: "GET"}), e.request(this.baseUrl + this.baseTld + "/sync_cookie_get", null, function (a, b) {
                ...
                if (a) {
                    try {
                        h = JSON.parse(b),
                            k = h.sync_token, u = h.sync_ok
                    } catch (l) {
                        return !1
                    }
                    e.setMethod("POST");
                    for (h = 0; h < c.length; h++)-1 == g.arrayIndexOf(u, c[h]) && function (a) {
            ...
            try {
                a = y.languages ? y.languages[0] : p.getLanguage()
            } catch (b) {
            }
    ...
    F.dispatchCustomEvent = t(function (a, b) {
        var c;
        b = b || f;
    ...
    var N = I.inherit({
        transports: [], postParams: [], dontSendRequests: !1, send: function (a, b, c, e) {
            ...
            this.dontSendRequests ? c.call(e) : function u(g) {
                if (g <
                    this.transports.length)try {
                    var h = new this.transports[g]({postParams: this.postParams});
                    h.request(a, b, function (a, b) {
                        a ? c.call(e, b) : u.call(this, g + 1)
                    }, this)
                } catch (f) {
                    oa(f, "send by " + (h && h.id)), u.call(this, g + 1)
                }
            }.call(this, 0)
        }
    });
    r.inherit({
        id: "beacon", request: function (a, b, c, e) {
            "function" == typeof y.sendBeacon ? (b = this._splitParams(b), c.call(e, y.sendBeacon(this._buildUrl(a, b.get), W.stringify(b.post)))) : c.call(e, !1)
        }
    });
    ...
    g.setTimeout = function (a, b, c) {
        return g.getNativeFunction("setTimeout")(t(a, c || "setTimeout"), b)
    };
    var Z = r.inherit({
        id: "form", enctype: "application/x-www-form-urlencoded", htmlfileOnly: !1, _initComponent: function () {
            ...
            "_htmlfile"in Z.prototype ||
            (Z.prototype._htmlfile = this._createHtmlfile());
            ...
            g.forEachKey(b.post, function (a) {
                g.mergeArrays(k,
                    ['<input type="hidden" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" name="', a, '"/>'])
            });
    ...
    }), J = Z.inherit({id: "htmlfile", htmlfileOnly: !0}), K = r.inherit({
    ...
    var L = N.inherit({
        protocol: "", host: "mc.yandex.ru", resource: "", counterId: "", counterType: 0, retry: !1,
        transports: [D, K, J], _initComponent: function () {
    ...
    var V = {
        ...
        tailSafe: "*-_",
        encode: function (a, b) {
            for (var c = (this.abc + (b ? this.tailSafe :
                this.tail)).split(""), e = a.length, d = [], h = e - e % 3, f, k = 0; k < h; k += 3)f = (a[k] << 16) + (a[k + 1] << 8) + a[k + 2], g.mergeArrays(d, [c[f >> 18 & 63], c[f >> 12 & 63], c[f >> 6 & 63], c[f & 63]]);
            switch (e - h) {
                case 1:
                    f = a[h] << 4;
        ...
        encode: function (a) {
            for (var b = [], c = 0, e = a.length; c < e; c++) {
                ...
                128 > d ? b.push(d) : (127 < d && 2048 > d ? b.push(d >> 6 | 192) : (b.push(d >> 12 | 224), b.push(d >>
                6 & 63 | 128)), b.push(d & 63 | 128))
            }
            return b
        }
    }, nb = L.inherit({
        ...
        sendContent: function (a, b, c, e, d, g, f) {
            ...
            a = {"wv-type": 1, "page-url": z().href, "wv-hit": c, "wv-data": V.encode(aa.encode(a))};
    ...
    g.throttle = function (a, b, c, e) {
        ...
        return function () {
            ...
            d || function () {
                d = null;
                f && (a.apply(c || h, f), f = null, d = g.setTimeout(arguments.callee,
                    b, e))
            }()
        }
    };
    var Va = I.inherit({
        ...
        _initComponent: function () {
            ...
            if (this.storage) {
                ...
                a && a.data && a.meta && a.time && a.time +
                this.bufferExpireTime > +new Date && this.onFlush.call(this.onFlushCtx || this, a.data, a.meta, a.pnum);
                this.clear()
            }
        },
        append: function (a, b) {
    ...
    p.getFlashVersion = function () {
        if (!p._flashVersion) {
            ...
            if ("undefined" != typeof a.plugins && "object" == typeof a.plugins["Shockwave Flash"]) {
                var b =
                    a.plugins["Shockwave Flash"], c = b.version;
    ...
    p.getFingerPrint = function () {
        var a = [];
        if (y.plugins && y.plugins.length)for (var b =
            0; b < y.plugins.length; b++) {
            var c = y.plugins[b];
            g.mergeArrays(a, [c.name, c.version, c.description, c.filename])
        }
        if (y.mimeTypes && y.mimeTypes.length)for (b = 0; b < y.mimeTypes.length; b++)c = y.mimeTypes[b], g.mergeArrays(a, [c.type, c.description, c.suffixes]);
        return g.fnv32a(a.join(";")) + "01"
    };
    p.isSafari = function () {
        try {
            return y.vendor && -1 < y.vendor.indexOf("Apple") && y.userAgent && !y.userAgent.match("CriOS")
        } catch (a) {
        }
        return !1
    };
    var qb = {
            url: "https://mc.yandex.ru/metrika/", _value: null, _storage: null, getVal: function () {
                ...
                this._storage || (this._storage = new Y);
        ...
        fa = L.inherit({
            ...
            _hitExt: function (a) {
                ...
                var c = a.modes || {},
                    e = a.browserInfo || {};
                if (!g.isMetrikaPlayer()) {
                    var d = "undefined" != typeof a.referrer ? a.referrer : ea, f = a.url, h = {};
                    c.ar && !c.onlyData && (d = null === d || "" === d ? "" : this._prepareHitUrl(d), f = this._prepareHitUrl(a.url));
                    b("page-ref", g.trim(d, ca));
                    b("page-url", g.trim(f, ca));
                    -1 != z().hostname.search(/(?:^|\.)(?:ya|yandex|narod|narod2)\.(?:\w+|com\.\w+)$/) ? b("ut", la) : "undefined" != typeof c.ut && b("ut", g.trim(c.ut, rb));
                    if (g.isObject(a.experiments)) {
                        var k = ["esid", "eeid", "egid"];
                        g.forEachKey(a.experiments, function (a, b) {
                            -1 !=
                            g.arrayIndexOf(k, a) && b && (e[a] = b)
                        })
                    }
                    if (a.userParams)if (f = g.toJSON(a.userParams), this.trimParams && f.length > sb)var l = !0; else b("site-info", f);
                    c.saveRef && (ea = d);
            ...
            _getTechInfo: function (a, b, c, e, d, f, k, E, t) {
                function m(a,
                           b) {
                    a && b && (r[a] = b)
                }
                ...
                R && m("s", R.width + "x" + R.height + "x" + (R.colorDepth || R.pixelDepth));
                ...
                m("z", d);
                m("i", e);
                m("et", Math.round((new Date).getTime() /
                1E3));
                m("en", l.getDocumentCharset());
                m("v", U);
                m("c", y.cookieEnabled ? "1" : "");
                ...
                c = new X({counterId: c});
                c.isEnabled() && (e = c.getStorageId(), (d = c.get("reqNum")) ? d++ : d = 1, c.set("reqNum", d), c.get("reqNum") == d ? (m("ls", e), m("rqn", d)) : (c.remove("reqNum"),
                    c.clearStorageId(), 1 < d && (m("ls", e), m("rqn", 0))));
                m("rn", g.random());
                m("hid", k);
                m("ds", gb(t));
                t._firstPaint || (t._firstPaint = hb(), m("fp", t._firstPaint));
                if (E) {
    ...
    var S = I.inherit({
        ...
        sendPacket: function (a, b, c, e, d, f, k, l) {
            ...
            var p = V.encode(a, !0);
            0 == p.indexOf("AAAAAAAAADw") && h.Error && "string" == typeof Error().stack && (new S({sampling: .1})).log("bad visor packet 5", 1);
            a = {
                rn: g.random(),
                "page-url": b,
                wmode: 0,
        ...
        protocol: "", counterId: "", counterType: "", meta: null,
        maxBufferSize: 7500, flushTimeout: 3E4, storageKey: "visorbuff", active: !1, _initComponent: function () {
    ...
    var ga = {};
    ga._cookie = new Y({onlyCurrentDomain: !0});
    ga.log = t(function () {
    ...
    var ub = L.inherit({
        resource: "clmap", retry: !0, transports: [K], sendClick: function (a, b, c, e) {
        ...
        _handler: function (a) {
            ...
            if (this._isTrackingClick(a)) {
                O = 3;
                var b = l.getElementSize(a.el), c = l.getElementXY(a.el), b = ["rn", g.random(), "x", Math.floor(65535 * (a.pos[0] - c[0]) / (b[0] || 1)), "y", Math.floor(65535 * (a.pos[1] - c[1]) / (b[1] || 1)), "t", Math.floor((a.time - this.startTime) / 100), "p", this._getElPath(a.el)];
                O = 4;
                c = z().href;
                this.isTrackHash ? g.mergeArrays(b, ["wh", "1"]) : c = c.split("#")[0];
                O = 5;
                this._sender.sendClick(g.trim(c, ca), b.join(":"));
                this._lastClick = a
            }
            O = 6
        },
        _isTrackingClick: function (a) {
            ...
            if (this._lastClick) {
                ...
                if (this._lastClick.el == a.el && b < this.DELTA_SAME_CLICKS && c < this.DELTA_SAME_CLICKS &&
                    e < this.TIMEOUT_SAME_CLICKS)return !1
            }
            if (this.hasQuota) {
    ...
    aa.decode = function (a) {
        for (var b = "", c = 0, e = 0, d = 0, g = 0; c < a.length;)e = a.charCodeAt(c), 128 > e ? (b += String.fromCharCode(e), c++) : 191 < e && 224 > e ? (d = a.charCodeAt(c + 1), b += String.fromCharCode((e & 31) <<
        6 | d & 63), c += 2) : (d = a.charCodeAt(c + 1), g = a.charCodeAt(c + 2), b += String.fromCharCode((e & 15) << 12 | (d & 63) << 6 | g & 63), c += 3);
        return b
    };
    V.decode = function (a, b) {
        for (; a.length % 4;)a += "=";
        ...
        do {
            ...
            d = g >> 8 & 255;
            g &= 255;
            l = 64 == f ? l + String.fromCharCode(e) : 64 == h ? l + String.fromCharCode(e, d) : l + String.fromCharCode(e,
                d, g)
        } while (k < a.length);
        return aa.decode(l)
    };
    var $a = fa.inherit({
        transports: [r], trimParams: !0, _initComponent: function () {
            ...
            c && (this._ilStorage.remove("il"), b.ilt = V.encode(aa.encode(g.trim(c, ab))));
            this._hitExt({
                url: a.url, title: a.title, referrer: a.referrer, userParams: a.userParams, experiments: a.experiments,
                modes: a.modes, browserInfo: b, ts: a.ts, tz: a.tz, callback: a.callback, ctx: a.ctx
            })
        }
    });
    ...
    var A = z(), za = Q.getTimezone(), Aa = Q.getTimestamp(), y = h.navigator, R = h.screen, U = "ver689".slice(3), rb = 64, ca = p.isIE() ? 512 : 2048, sb = p.isIE() ? 512 : 2048, Wa = p.isIE() ? 100 : 400, ab = 100, la = "noindex", bb = /\.(3gp|7z|aac|ac3|acs|ai|avi|ape|apk|asf|bmp|bz2|cab|cdr|crc32|css|csv|cue|divx|dmg|djvu?|doc(x|m|b)?|emf|eps|exe|flac?|flv|iso|swf|gif|t?gz|jpe?g?|js|m3u8?|m4a|mp(3|4|e?g?)|m4v|md5|mkv|mov|msi|ods|og(g|m|v)|pdf|phps|png|ppt(x|m|b)?|psd|rar|rss|rtf|sea|sfv|sit|sha1|svg|tar|tif?f|torrent|ts|txt|vob|wave?|wma|wmv|wmf|webm|xls(x|m|b)?|xpi|g?zip)$/i,
        wb = +new Date, ma, ha, na = !!Ya._metrika.oo;
    Ya._metrika.v = U;
    h.Ya.Metrika = function (a, b, c, e) {
        ...
        return t(function () {
            function u(x) {
                var q = !1;
                if (Ya._metrika.hitParam[J]) {
                    if (1 != c || Ya._metrika.counters[J])return !1;
                    q = !0
                }
                Ya._metrika.counters[J] = d;
                Ya._metrika.hitParam[J] = 1;
                ...
                if (!e && !q) {
                    ...
                    "b" != n && "w" != n && (n = "");
                    if (!H.isEnabled() || ia("opera mini"))n = "b";
                    ma = +new Date;
                    var q = new $a({
                        protocol: "https:",
                        counterType: c,
                    ...
                    q.sendHit({
                        ...
                        callback: function (c) {
                            ...
                            if (R) {
                                ...
                                "w" == n ? (R.start(), q = e.arch_type, (e = e.urls) && q && "none" != q && R.uploadPages(e, q)) : R.stop()
                            }
                            c = c.mp2;
                            H.erase("mp2_substs");
                            if (c) {
                                b:if ((e = c.conditions) && e.length)for (q = 0; q < e.length; q++) {
                                    var x;
                                    x = e[q];
                                    if ("ref" == x.type)x = ib(x); else if ("adv" == x.type) {
                                        var l = x, m = Ya._metrika.counter._directCampaign, p = l.ServiceNamePattern, r = l.RefererPattern;
                                        x = m ? l.direct_orders : l.direct_camp;
                                        for (var u =
                                            f.referrer, t = W.parse(A.search), y = jb(A.search, A.hash), z = {}, C = ["source", "medium", "campaign", "term", "content"], v = 0; v < C.length; v++)t["utm_" + C[v]] && (z[C[v]] = t["utm_" + C[v]]);
                                        v = m ? "direct.yandex.ru" : y && y.service || z.source;
                                        C = !1;
                                        if (!C && p && p.length)for (var w = 0; w < p.length; w++)if ((new RegExp(p[w], "i")).test(v)) {
                                            C = !0;
                                            break
                                        }
                                        if (!C && !l.yandex_direct && r && r.length)for (p = 0; p < r.length; p++)if ((new RegExp(r[p], "i")).test(u)) {
                                            C = !0;
                                            break
                                        }
                                        !C && l.google_adwords && t.gclid && (C = !0);
                                        if (C && x && x.length && (C = !1, l = m || y && y.campaign || z &&
                                ...
                                e && c ? (H.create("mp2_substs", g.toJSON(c)), c = La(c), d.params("__ym", c ? "mp_trackid" : "mp_trackid_bad", e)) : Ma()
                            } else Ma();
                ...
                y();
                v && (v.enableAll ? (r(!0), m(!0), D()) : (v.clickmap && m(v.clickmap), v.trackLinks && r(v.trackLinks),
                v.accurateTrackBounce && D(v.accurateTrackBounce)), (v.ecommerce || v.useDataLayer) && new Za({
                    counter: d,
                    prefsEcommerce: v.ecommerce
                }), v.triggerEvent && cb(function () {
                    F.dispatchCustomEvent("yacounter" + a + "inited")
                }, 0, "triggerEvent"));
                d._webvisor && !na && (R = new kb("https:", a, c, Q, d))
            }
            ...
            function I(a) {
                ...
                if (b) {
                    ...
                    var c = "" + b.href, d = c ? c.split(/\?/)[0] : "", e = function (a) {
                        ...
                        P.sendClickLink({url: c, title: c == d ? "" : d, modes: a})
                    };
                    if (bb.test(d) || bb.test(c) || Ja(c, ka) || Ja(d, ka))a = !0;
                    var f = l.classNameExists(b, "ym-disable-tracklink"), d = l.classNameExists(b, "ym-external-link");
                    f || (f = {
                        ln: !0,
                        dl: a
                    }, d ? e(f) : (d = b.hostname || g.parseUrl(b.href).hostname || "", eb(z().hostname, d) ? a ? (f.ln = !1, e(f)) : (a = Ca(b.innerHTML.replace(/<\/?[^>]+>/gi, ""))) && a != c &&
                    da.set("il", g.trim(a, ab)) : c && -1 != c.search(/^ *(data|javascript):/i) || (f.ut = la, e(f))))
                }
            }
            ...
            function D(b) {
                ...
                if (!d._isAccurateTrackBounce) {
                    ...
                    var c = new X({counterId: a}), e = c.get("lastHit");
                    c.set("lastHit", +new Date);
                    ((c = c.get("lastHit")) && (!e || e < c - 18E5) || !fb(f.referrer, z().href) || .1 > Math.random()) && n(function () {
                        d.notBounce()
                    }, b)
                }
            }
            ...
            function K(a) {
                ...
                (function C() {
                    var d = b();
                    d !== c && (a(), c = d);
                    ca = g.setTimeout(C, 200, "trackHash")
                })()
            }

            function N(a) {
                if (!1 ===
                    a)w && ("onhashchange"in h ? k.un(h, "hashchange", O) : g.clearTimeout(ca), w = !1); else if (a = O, !w) {
                    if ("onhashchange"in h)k.on(h, "hashchange", a); else K(a);
                    w = !0
                }
                P.setTrackHash(w);
                d._trackHash = w
            ...
            function O() {
                ...
                P.sendAjaxHit({url: z().href, title: l.getDocumentTitle(), referrer: Z, modes: a});
                V = z().href
            }

            function M(a, b, c) {
                a = G.parseValidate(a, b);
                b = [];
                a && (b.push(a), c = c || {}, g.isFunction(c.callback) && (b.push(c.callback), c.ctx && b.push(c.ctx)));
                b.length && d.params.apply(d,
                    b)
            }

            var J, S = "", U, V = ea = A.href, Z = "", v;
            Ya._metrika.counter || (Ya._metrika.counter = d);
            "object" == typeof a && (v = a, e = a.defer, S = a.ut, c = a.type, b = a.params, U = v.experiments, a = a.id);
            a = a || 0;
            /^\d+$/.test(a) || (a = 0);
            c = c || 0;
            J = a + ":" + c;
            if (Ya._metrika.counters[J])return Ya._metrika.counters[J];
            var Q = Ya._metrika.hitId;
            Ya._metrika.counterNum++;
            var aa = Ya._metrika.counterNum;
            L.initCookie();
            L.retransmit();
            var P = new fa({
                protocol: "https:",
            ...
            d.reachGoal = t(function (b, c, e, g) {
                2 <= arguments.length && "function" === typeof c && (g = e, e = c, c = ba);
                ga.log("Reach goal. Counter: " + a + ". Goal id: " + b + ". Params: ", c);
                P.sendGoal(b, {userParams: c, callback: e, ctx: g});
                return d
            }, "counter.reachGoal");
            d.trackLinks = t(function (a) {
                r(a);
                return d
            }, "counter.trackLinks");
            var da = new X({counterId: a});
            d.hit = t(function (b,
                                c, e, f, h, k) {
                b && (g.isObject(c) && (e = c.referer, f = c.params, h = c.callback, k = c.ctx, c = c.title), ga.log("PageView. Counter " + a + ". URL: " + b + ". Referrer: " + e + ". Params: ", f), P.sendHit({
                    url: b,
                    title: c,
                    referrer: e,
                    userParams: f,
            ...
            d.params = t(function (b) {
                var c = arguments.length, e = c, f, h, k = [].slice.call(arguments, 0);
                b && (1 < arguments.length && (g.isFunction(arguments[c - 1]) ? (f = arguments[c - 1], e = c - 1) : g.isFunction(arguments[c - 2]) && (f = arguments[c - 2], h = arguments[c - 1], e = c - 2), k = [].slice.call(k,
                    0, e), 1 < k.length && (k = [g.array2Props(k)])), ga.log("User params. Counter " + a + ". Params: ", k[0]), P.sendParams(k[0], f, h));
                return d
            }, "counter.params");
            d.file = t(function (a, b) {
            ...
            d.notBounce = t(function (a) {
                var b = 0;
                a = a || {};
                ma && ha &&
                (b = ha - ma);
                P.sendNotBounce(b, {callback: a.callback, ctx: a.ctx});
                return d
            }, "counter.notBounce");
            var ka = [];
            ...
            d.ecommerceDetail = t(function (a, b) {
                    M("detail", a, b);
                    return d
                },
                "ecommerce.detail");
            d.ecommerceAdd = t(function (a, b) {
                M("add", a, b);
                return d
            }, "ecommerce.add");
            d.ecommerceRemove = t(function (a, b) {
                M("remove", a, b);
                return d
            }, "ecommerce.remove");
            d.ecommercePurchase = t(function (a, b) {
                M("purchase", a, b);
                return d
            }, "ecommerce.purchase");
            d.userParams = t(function (a, b, c) {
                g.isObject(a) && d.params({__ymu: a}, b || function () {
                }, c);
                return d
            }, "uparams");
            d.experiments = t(function (a, b, c) {
                P.sendExperiments({callback: b, ctx: c, experiments: a});
                return d
            }, "exps");
            d.id = d.setUserID = t(function (a, b, c) {
                (g.isString(a) ||
            ...
            if (a)if ("prerender" == f.webkitVisibilityState) {
                P.sendPrerenderHit({url: A.href, title: l.getDocumentTitle(), referrer: f.referrer});
                var qa = function () {
                    "prerender" != f.webkitVisibilityState && (k.un(f, "webkitvisibilitychange", qa), u(!0))
                };
    ...
    if (h.performance && "function" == typeof performance.getEntries) {
        ...
        for (r = 0; r < N.length; r++) {
            var K = N[r], da = K.name.replace(/^https?:\/\//, "").split("?")[0], xb = g.fnv32a(da);
            D[xb] && !J[da] && 0 < K.duration && (J[da] = {
                ...
                response: Math.round(K.responseEnd -
                K.requestStart),
                pages: A.href
            })
        }
        (new S({sampling: .001})).logParams({timings8: J})
    }
    ...
    D = h.yandex_metrika_callbacks;
    "function" == typeof r && r();
    if ("object" == typeof D)for (r = 0; r < D.length; r++)if (N = D[r])D[r] = null, N();
    qa("yandex_metrika_callback");
    qa("yandex_metrika_callbacks");
    D = ["link", "click", "scroll", "res"];
    for (r = 0; r < D.length; r++)if (N = D[r] + "map", -1 != A.href.search("ym_playback=" + N)) {
        Na("https://old.metrika.yandex.ru/js/" +
        N + "/_loader.js");
        break
    }
    h.Ya.Metrika.informer = function (a) {
        ...
        b || Na("https://informer.yandex.ru/metrika/informer.js")
    };
    (function () {
        var a = function () {
